...
public abstract class BaseNodeImpl implements BaseNodeInterface {
	...
	private BaseNode getBaseNode(long nodeId) throws UnauthorizedException {
	 ...
	 */
	protected <E> E getNode(Class<E> nodeEntityClass, long nodeId) throws UnauthorizedException {
	...
	public String getName(long nodeId) throws UnauthorizedException {
		return getBaseNode(nodeId).getName();
	}

	@TransactionAttribute(TransactionAttributeType.REQUIRED)
	public void setName(long nodeId, String name) throws UnauthorizedException {
		BaseNode node = getBaseNode(nodeId);
		node.setName(name);
		em.merge(node);
	}

	public String getDisplayName(long nodeId) throws UnauthorizedException {
		return getBaseNode(nodeId).getDisplayName();
	}

	@TransactionAttribute(TransactionAttributeType.REQUIRED)
	public void setDisplayName(long nodeId, String name) throws UnauthorizedException {
		BaseNode node = getBaseNode(nodeId);
	...
	public List<Long> getAdmins(BaseNode node) throws UnauthorizedException {
	...
	/** Get a User by id. */
	protected User getUser(long userId) throws UnauthorizedException {
		return (User) em.find(User.class, userId);
	}

	protected boolean isAdmin(BaseNode node, long userId) throws UnauthorizedException {
	 ...
	 */
	@TransactionAttribute(TransactionAttributeType.REQUIRED)
	protected void addAdmin(BaseNode node, long userId) throws UnauthorizedException {
	 ...
	 * @param nodeEntityClass
	 */
	protected void removeNode(long nodeId, Class<?> nodeEntityClass) throws UnauthorizedException {
	 ...
	 */
	protected List<Long> getNodesWhereIsAdmin(Class<?> nodeEntityClass) throws UnauthorizedException {
